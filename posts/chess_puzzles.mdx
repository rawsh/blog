...
date: 2024-08-24
description: Explore how LLMs can be optimized to solve chess puzzles, comparing performance between completion and chat models.
...
I'm working on a lichess bot that you can play against to try out the optimized LLM programs. Stay tuned 😎
